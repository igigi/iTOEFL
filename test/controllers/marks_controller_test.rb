...
class MarksControllerTest < ActionController::TestCase
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post :create, mark: { content: @mark.content, question_history_id: @mark.question_history_id, user_id: @mark.user_id }
    end
  ...
  test "should update mark" do
    patch :update, id: @mark, mark: { content: @mark.content, question_history_id: @mark.question_history_id, user_id: @mark.user_id }
    assert_redirected_to mark_path(assigns(:mark))
  end
