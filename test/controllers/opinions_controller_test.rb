...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { content: @opinion.content, discussion_id: @opinion.discussion_id, media_url: @opinion.media_url, seat: @opinion.seat, user_id: @opinion.user_id }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { content: @opinion.content, discussion_id: @opinion.discussion_id, media_url: @opinion.media_url, seat: @opinion.seat, user_id: @opinion.user_id }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
