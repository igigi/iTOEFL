...
class JudgementsControllerTest < ActionController::TestCase
  ...
  test "should create judgement" do
    assert_difference('Judgement.count') do
      post :create, judgement: { mark_id: @judgement.mark_id, score: @judgement.score, user_id: @judgement.user_id }
    end
  ...
  test "should update judgement" do
    patch :update, id: @judgement, judgement: { mark_id: @judgement.mark_id, score: @judgement.score, user_id: @judgement.user_id }
    assert_redirected_to judgement_path(assigns(:judgement))
  end
